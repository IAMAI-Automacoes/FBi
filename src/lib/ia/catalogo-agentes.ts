...
{feedbacks}` }],
  },
  {
    ...
    nome: 'Criador de ações (edge function)',
    papel: 'Quando o dono clica "Criar Ação", transforma aquele insight numa ação com plano — nunca a partir de um feedback único.',
    memoria: 'SEM memória de conversa. Vê o insight escolhido, os feedbacks dele e a configuração.',
    acessos: ['Insight escolhido', 'Perfil do restaurante', 'Anotações da IA (memoria_assistente)', 'Materiais de treinamento', 'Busca na web', 'Grava em: acoes_operacionais'],
